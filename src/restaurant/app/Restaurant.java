...
import restaurant.model.CategoryName;
    ...
    public static void main(String[] args) {
        ...
        MenuItem lasagnaFritta = new MenuItem
                ("Lasagna Fritta",
                        ...
                        CategoryName.APPETIZER, dateOfOldItem);
        // old item
        MenuItem chickenAlfredo = new MenuItem
                ("Chicken Alfredo",
                        17.29,
                        "Classic Chicken Alfredo.",
                        CategoryName.MAIN_COURSE, dateOfOldItem);
        // new item
        ...
        while (true) {
            ...
            // ADD
                ...
                do {
                    ...
                    if (menu.checkFoDuplicate(newName)) {
                ...
                CategoryName newCategoryName = CategoryName.DESSERT;
                valid = false;
                do {
                    ...
                    if (catIndx < 0 || catIndx > 2) {
                        ...
                        valid = true;
                        if (catIndx == 0) newCategoryName = CategoryName.APPETIZER;
                        else if (catIndx == 1) newCategoryName = CategoryName.MAIN_COURSE;
                    }
                } while (!valid);
                MenuItem newItem = new MenuItem(newName, newPrice, newDescription, newCategoryName);
            ...
            // DELETE
                ...
                // checking for duplicate
                if (!menu.checkFoDuplicate(delete)) {
